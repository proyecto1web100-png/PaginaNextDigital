...
Landing page de NextDigital, estudio de diseño web en Honduras. La página principal publicada es `prueba3`. El repositorio tiene tres versiones de prueba:
...
`prueba2` y `prueba3` se exportan como sitio estático (`npm run build` genera `out/`). Para publicarlo en una sub-ruta de GitHub Pages, construir con `NEXT_PUBLIC_BASE_PATH=/PaginaNextDigital/prueba3 npm run build` (o `/PaginaNextDigital` para la raíz).
